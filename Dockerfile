...
RUN ln -s stanford-corenlp-full-2018-10-05 stanford-corenlp
WORKDIR stanford-corenlp
RUN ln -s stanford-corenlp-3.9.2.jar stanford-corenlp.jar
#RUN wget https://nlp.stanford.edu/software/stanford-postagger-full-2018-10-05.zip
#RUN ln -s stanford-postagger-full-2018-10-05 taggers
...
RUN ln -s stanford-english-corenlp-2018-10-05-models.jar english-models.jar
RUN wget http://nlp.stanford.edu/software/stanford-english-kbp-corenlp-2018-10-05-models.jar
RUN ln -s stanford-english-kbp-corenlp-2018-10-05-models.jar english-kbp-models.jar
